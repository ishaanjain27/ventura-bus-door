...
def A_matrix_builder(N,E_MODULUS,INERTIA,EI,dx): 
...
def BC_clamped_free(A_withoutBCs, dx):
    ...
    A_withoutBCs[1,0] = -1/dx
    A_withoutBCs[1,1] = 1/dx   # u'(x=0) = 0

    # Applying free BC to right side
    A_withoutBCs[-1,:] = 0
    A_withoutBCs[-2,:] = 0

    A_withoutBCs[-2,-1] = 1 /dx**2
    A_withoutBCs[-2,-2] = -2 / dx**2 # this part applies u''(x=N+1) = 0 using central dif
    A_withoutBCs[-2,-3] = 1 / dx**2
    ...
    A_withoutBCs[-1,-1] = 1/dx**3
    A_withoutBCs[-1,-2] = -3/dx**3    # this part applies u'''(x=N+1) = 0 using backward dif
    A_withoutBCs[-1,-3] = 3/dx**3
    A_withoutBCs[-1,-4] = -1/dx**3
